...
N_STEPS = 20  # количество действий совершаемых в каждой среде для накопления опыта перед обновлением весов
TOTAL_TIMESTEPS = 1000  # суммарное количество действий, которое бедет совершено за весь период обучения
BATCH_SIZE = 4  # размер батча
N_EPOCHS = 5  # количество PPO-эпох (итераций обновления весов с набранным опытом)
...
ENT_COEF = 0.01  # коэффициент штрафа за низкую энтропию
